        ...
        if (clientReady && !updatingStatsFeed) {
            ...
            const statsEmbed = new MessageEmbed()
                ...
                .addFields(
                    ...
                    { name: '180-Day APY (F)' + moneyBagEmoji, value: fantomMetrics.apy, inline: true },
                    { name: 'Total Value Locked (F)', value: fantomMetrics.tvl, inline: true },
                    { name: 'ROI (180 Day Rate) (F)', value: fantomMetrics.fiveDayRate, inline: true },
                    { name: '180-Day APY (M)' + moneyBagEmoji, value: moonRiverMetrics.apy, inline: true },
                    { name: 'Total Value Locked (M)', value: moonRiverMetrics.tvl, inline: true },
                    { name: 'ROI (180 Day Rate) (M)', value: moonRiverMetrics.fiveDayRate, inline: true },
